...
{
	public EHC(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit, String className)
	{
	...
	private void generateEHC(CatchBlock p, String e_name)
	{
	...
	public void outputToFile(CatchBlock p, String exception_type)
	{
		...
		String f_name;
		num++;
		f_name = getSourceName(this, className, getMutantType("EHC"));
