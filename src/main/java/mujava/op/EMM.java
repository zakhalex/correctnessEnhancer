...
{
   public EMM(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit, String className)
   {
   ...
   public void outputToFile (MethodCall original, MethodCall mutant)
   {
      ...
      String f_name;
      num++;
      f_name = getSourceName(this, className, getMutantType("EMM"));
