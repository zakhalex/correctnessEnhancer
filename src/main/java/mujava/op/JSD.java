...
/**
 * <p>
 * Generate JSD (Java-specific static modifier deletion) --
...
public class JSD extends mujava.op.util.Mutator
{
	...
	public JSD(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit, String className)
	{
	...
	public void outputToFile(FieldDeclaration original)
	{
		...
		String f_name;
		num++;
		f_name = getSourceName(this, className, getMutantType("JSD"));
