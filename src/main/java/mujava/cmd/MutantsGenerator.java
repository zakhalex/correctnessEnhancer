...
//	{
//		File f = new File("J:\\PhD\\MuJava\\src\\shared");
//		
//		generateMutants(f.list());
//	}
...
//    File originalDir = new File(MutationSystem.MUTANT_HOME+"/"+MutationSystem.getDirectory()
//                                + "/" + MutationSystem.ORIGINAL_DIR_NAME);
//    while(originalDir.delete()){
//    }
//
//    File cmDir = new File(MutationSystem.MUTANT_HOME+"/"+MutationSystem.getDirectory()
//                                + "/" + MutationSystem.CM_DIR_NAME);
//    while(cmDir.delete()){}
//
//    File tmDir = new File(MutationSystem.MUTANT_HOME+"/"+MutationSystem.getDirectory()
//                                + "/" + MutationSystem.TM_DIR_NAME);
//    while(tmDir.delete()){}
//
//    File myHomeDir = new File(MutationSystem.MUTANT_HOME+"/"+MutationSystem.getDirectory());
