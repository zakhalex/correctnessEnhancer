...
public class AODS extends MethodLevelMutator
{
	...
	public AODS(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit, String className)
	{
	...
	public void outputToFile(UnaryExpression original)
	{
		...
		String f_name;
		num++;
		f_name = getSourceName("AODS", className, getMutantType("AODS"));
