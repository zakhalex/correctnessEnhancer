 ...
 * (2) choose mutation operator(s) to applied
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class MutantsGenPanel extends JPanel
{
	...
	void runB_mouseClicked(MouseEvent e)
	{
		...
		Collection<String> file_list = fTableModel.getSelectedFiles();
		...
		Collection<String> class_ops = cmoTableModel.getSelectedOprators();

		TMOTableModel tmoTableModel = (TMOTableModel) traditionalOpTable.getModel();
		Collection<String> traditional_ops = tmoTableModel.getSelectedOprators();

		if ((class_ops == null || class_ops.size() == 0) && (traditional_ops == null || traditional_ops.size() == 0))
		{
 ...
 * and class-level mutation operators
 * </p>
 * <p>
...
abstract class MOTableModel extends AbstractTableModel
{
	...
	public Collection<String> getSelectedOprators()
	{
