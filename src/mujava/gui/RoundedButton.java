...
//            g.setColor(getBackground().darker().darker());
            colorGradient = new GradientPaint(new Point(0,0), getBackground().darker(), new Point(getWidth() - 1, getHeight() - 1), getBackground().darker().darker());

        } else {
//            g.setColor(getBackground());
        	colorGradient = new GradientPaint(new Point(0,0), getBackground(), new Point(getWidth() - 1, getHeight() - 1), getBackground().darker());
        }
