 ...
 * @throws Exception 
   ...
   {
	  this.setTitle("Correctness Enhancer");
      genPanel = new MutantsGenPanel(this);
      cvPanel = new ClassMutantsViewerPanel();
      tvPanel = new TraditionalMutantsViewerPanel();
      RunTestPanel runPanel = new RunTestPanel();
      mutantTabbedPane.setUI(new CustomTabbedPaneUI());
      ...
      mutantTabbedPane.add("TestCase Runner", runPanel);
