...
/**
 * <p>
 * Template for viewing method-level mutants: show original source code,
 * source code of the selected mutants, summary of mutants
 * </p>
 * 
 * @author Yu-Seung Ma
 * @version 1.0
...
public class TraditionalMutantsViewerPanel extends MutantsViewerPanel
{
	...
	public void showMutant(String dir_name, String mutant_log)
	{
		...
		{
			System.err.println(" [error] TraditionalMutantsViewerPanel " + e);
		}
	}
