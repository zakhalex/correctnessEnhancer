...
public class CustomTabbedPaneUI extends BasicTabbedPaneUI
{
			...
			boolean isSelected)
	{
		...
		switch (tabPlacement)
		{
			...
			case TOP:
			default:
				xp = new int[] { x, x, x + 3, x + w - inclTab - 6, x + w - inclTab - 2, x + w - inclTab,
						x + w - inclTab, x };
	...
	/*
	 * protected void paintText(Graphics g, int tabPlacement, Font font, FontMetrics metrics, int tabIndex, String title, Rectangle textRect, boolean
	 * isSelected) {
	 * g.setFont(font);
	 * View v = getTextViewForTab(tabIndex);
	 * if (v != null) {
